...
public class JpaTest {
    ...
    public static Archive createDeployment() {
        ...
        WebArchive arch = ShrinkWrap.create(WebArchive.class, "login.war")
                ...
                .addAsWebInfResource(new FileAsset(new File("src/main/resources/META-INF/persistence.xml")), "/classes/META-INF/persistence.xml");
    ...
    public void testControllerInjectionandJpaUpdates() {
        ...
        //assertNotNull("User must not be null now", userController.getSelected().getId()); //so we should have a correct entry
    ...
    public void testJpaDelete() {
        ...
        //now we get the data ... read it ... and after that update it and then delete it ...
    }
}
